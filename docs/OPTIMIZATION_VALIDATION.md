...
Current repository test commands and CI scope are documented in [testing.md](testing.md). Windows GPU inference and clean GPU-runtime reconstruction remain unverified. English/Chinese application UI is covered by mocked browser tests; this does not re-certify GPU inference. Private execution logs and gallery screenshots are intentionally not distributed.
